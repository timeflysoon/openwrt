...
鉴于近期频繁遭遇无端骚扰与纠缠，现就相关事宜作出如下说明：

一、关于固件编译方式
自即日起，固件将不再使用OpenWrt/ImmortalWrt源码进行在线编译，后续将切换至官方源码实体机编译。此举实属无奈，望各位理解。

郑重声明：本人不以任何形式售卖固件。所设立的VIP交流群，仅面向对本人开发工作给予肯定与支持的朋友，作为交流分享的平台，无任何商业性质。

二、关于GPL协议问题
关于GNU General Public License v2.0（GPLv2）相关事宜，已无需进一步讨论。

本人开发的代码中，90%以上已在仓库中开源。需要明确的是：这些自研插件的开源与否，由我本人决定——开源是分享，不开源是本分，这完全符合开源精神中“自愿”的基本原则。

若对我开发的插件有合理需求，欢迎通过正规渠道理性沟通。但如果继续借此进行无端指责与骚扰，那才是对开源精神的真正误解，绝非真正的开源社区所为。

三、关于骚扰问题的态度
若本人开源代码确实给您造成困扰，请直接明言。如果大家普遍认为不开源更好，本人亦可选择不再开源，免生纷扰。这一态度始终未变。

四、关于固件发布的立场
如发布编译好的固件本身即构成违规，烦请直接向OpenWrt官方申请出具禁止编译的正式公函。一旦官方有此明确要求，本人必当遵从。

五、关于近期争议事件
近期相关争议详见以下链接，各位可自行审阅判断：

- [在线编译链接一](https://github.com/sirpdboy/openwrt/issues/638)  
- [网络测速链接二](https://github.com/sirpdboy/luci-app-ddns-go/issues/110)

更多无理且令人不适的对话，恕不在此展示，以免影响大家心情。多余的话不再说，请大家各自观阅。是非对错，相信各位自有公断。
...
固件内核和依赖不断更新升级，编译也是不断纠错和进步之中，新固件会有新插件、也会加入新功能、也许会有新问题，但总之要相信，代码的升级，总是解决前面的问题才会更新，一切都是在朝前进，有问题慢慢来，别急，总有解决方法 。也许本人不是最会处理BUG的编译者，也不是能解决所有BUG的大神，但肯定是最用心来编译固件的编译者。因为每一次更新编译，本人都会不断尝试与改进，加入新功能解决旧问题，方便使用和好用的固件一直是本人编译固件的崇旨。在感谢所有支持本人的好伙伴们！
